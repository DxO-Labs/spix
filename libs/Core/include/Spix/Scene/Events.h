...
public:
    ...
    virtual void mouseDown(Item* item, Point loc, MouseButton button, KeyModifier mod, bool eventToItem = false) = 0;
    virtual void mouseUp(Item* item, Point loc, MouseButton button, KeyModifier mod, bool eventToItem = false) = 0;
