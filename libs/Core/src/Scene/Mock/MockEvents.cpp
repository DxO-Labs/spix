...
void MockEvents::mouseDown(Item* item, Point loc, MouseButton /*button*/, KeyModifier /*mod*/, bool /*eventToItem*/)
{
...
void MockEvents::mouseUp(Item* item, Point loc, MouseButton /*button*/, KeyModifier /*mod*/, bool /*eventToItem*/)
{
    if (onMouseClickEvent) {
