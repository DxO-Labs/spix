...
public:
    void mouseDown(Item* item, Point loc, MouseButton button, KeyModifier mod, bool eventToItem = false) override;
    void mouseUp(Item* item, Point loc, MouseButton button, KeyModifier mod, bool eventToItem = false) override;
